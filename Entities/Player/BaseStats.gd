...
export(float) var jump_force : float = 280
export(float) var max_speed = 200
export(float) var acceleration = 360
export(float) var terminal_velocity = 600 
export(float) var gravity = 650
export(float) var falling_gravity_modifier = 1.8
export(float) var friction = 1.5
export(float) var air_acceleration_modifier = 0.8
export(float) var air_friction_modifier = 0.5
export(float) var stopping_friction_modifier = 5.5
